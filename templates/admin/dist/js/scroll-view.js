...
var ScrollView = Backbone.View.extend({
    ...
    events: {
        ...
        "click .approved": function (e) {
          //console.log(e);
          $(e.target).toggleClass( "text-green" );
          var slug = $(e.target).data('slug');
          console.log(slug);
          $.get("/api/web/places/approve?slug="+slug, function(data, status){
            console.log("Data: " + data + "\nStatus: " + status);
          });
        },
        "click .feature": function (e) {
          //console.log(e);
          $(e.target).toggleClass( "text-red" );
          var slug = $(e.target).data('slug');
          console.log(slug);
          $.get("/api/web/places/feature?slug="+slug, function(data, status){
            console.log("Data: " + data + "\nStatus: " + status);
          });
        },
